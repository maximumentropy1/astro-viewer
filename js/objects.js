...
var objects = [
    ...
    {objName: "Uranus",
     description: "<b>Uranus and Neptune</b><br>Uranus and Neptune are both gas giants, similar to Jupiter and Saturn. However, they are smaller in size and slightly different in their atmospheric composition. While Jupiter and Saturn are almost entirely hydrogen and helium, Uranus’ and Neptune’s atmospheres contain a significant amount of methane. All gasses <a class='link' onclick='termLink(0)'>absorb</a> certain <a class='link' onclick='termLink(0)'>wavelengths</a> of light, and Uranus and Neptune’s thick atmospheres result in almost all red wavelength light being <a class='link' onclick='termLink(0)'>absorbed and radiated</a> by the planet, causing a blue-green color. Neptune. Uranus is distinct from Neptune in that its axis of rotation is perpendicular, rather than parallel, to its axis of revolution. In other words, Uranus “rolls” around the plane of its orbit",
     imgLink: "",
     x: 2325.4,
     y: 540.05,
     visited: false,
    ...
    {objName: "Crab Pulsar",
    description: "The Crab Nebula was bright enough to see during the daytime one thousand years ago. By today, it has dimmed significantly from <a class='link' onclick='termLink(0)'>radiating</a> so much energy away. Now, through the Hubble Space Telescope, upon very close inspection, we can see a tiny white star - the remains of the star that exploded.<br><br><b>Pulsars and Neutron Stars</b><br>Gravity pulls everything inward. In a normal star, the gravity of so much mass is counteracted by <a class='link' onclick='termLink(1)'>gas pressure</a>. Since PV=nRT (from chemistry), the hotter a star is, the more gas pressure is created. Nuclear fusion keeps the core of a normal star very hot, allowing it to support itself. But what if the star has run out of nuclear fuel? Gravitational contraction releases energy, so some stars (white dwarves) can stave off total collapse through the heat from their own collapse. But when the star is too large and can’t fuse, quantum mechanics takes over. Since no two electrons can be in the exact same state at once, eventually the star collapses so far electrons are “smushed” together and can’t be pushed closer together. This pressure from these electrons is known as “electron degeneracy pressure”. Neutron stars as a consequence of this are extremely dense, and extremely hot from the energy released as they collapsed. They also spin extremely quickly due to conservation of <a class='link' onclick='termLink(4)'>angular momentum</a> (smaller radius = less inertia, since angular momentum is spin speed * inertia, spin speed increases). Their magnetic fields direct electromagnetic <a class='link' onclick='termLink(0)'>radiation</a> towards their magnetic poles, causing two beams of energy to shoot out. As they spin, their beams sometimes shine on our planet. This shining/not shining effect is why these neutron stars are known as pulsars.",
    ...
    {objName: "M87's Awesome Jet",
     description: "From M87’s black hole extends a massive, extremely bright line (shown in blue) all the way across the galaxy and beyond. This line is actually a jet of gas moving at relativistic speeds, hence its name “relativistic jet”. In fact, it moves so fast that relativistic effects (and/or some theorized optical illusions) make it appear to move faster than the speed of light. The cause of this jet, while unclear, is believed to be a giant torus (donut) of gas directing the super energized gas shooting out of the black hole. The gas itself gets its extreme speed and energy from the gravitational <a class='link' onclick='termLink(2)'>potential energy</a> of material falling into a black hole",
